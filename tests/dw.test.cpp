...
TEST(DoubleWord, imp_mul) {
  ...
  EXPECT_EQ(test1.hi(), 20326714295214550165034312400896.0);
  EXPECT_EQ(test1.lo(), 2027866261386626.5);
...
TEST(DoubleWord, multi_op) {
  ...
  EXPECT_EQ(test5.hi(), 20326714295214550165034312400896.0);
  EXPECT_EQ(test5.lo(), 2027866261386626.5);

  dbl_wrd test8 = dbl_wrd(4505619370757448, -0.049978163438562706044621108958381228148937225341796875);
  test8 *= 4511413997183120.0;
  EXPECT_EQ(test8.hi(), 20326714295214550165034312400896.0);
  EXPECT_EQ(test8.lo(), 2027866261386626.5);
  ...
  EXPECT_EQ(test7.hi(), 20326714295214550165034312400896.0);
  EXPECT_EQ(test7.lo(), 2027866261386626.5);
